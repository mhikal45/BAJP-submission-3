...
import com.catalog.moviecatalogapp.data.source.CatalogDataSource
...
class FakeCatalogDataRepository (
    ...
    override fun setMovieFavorite(movie: MovieEntity, state: Boolean) {
        localDataSource.updateMovie(movie,true)
    }

    override fun setTvShowFavorite(movie: TvShowEntity, state: Boolean) {
        localDataSource.updateTvShow(movie,true)
    }
}